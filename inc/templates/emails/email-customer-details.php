...
global $translation_language; __( 'Details zum Kunden', 'nutrisslim-suiteV2' );
?>
<?php if ( ! empty( $fields ) ) : ?>
<div style="font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin-bottom: 40px;">
    <h2><?= apply_filters( 'wpml_translate_single_string', 'Customer details', 'nutrisslim-suiteV2', 'Customer details', $translation_language ); ?>
    </h2>
    <ul>
