    ...
    function filter_submit_review_page_content( string $content ): string {
        ...
        <div class="mass-reviews container container-px">
            <div class="review-intro">
                <h1 class="bold"><?php echo esc_html__('Din åsikt är viktig för oss', 'nutrisslim-suite'); ?></h1>
                <p><?php echo esc_html__('På Nature\'s Finest strävar vi alltid efter att erbjuda de bästa produkterna och tjänsterna till våra uppskattade kunder. Vill du betygsätta ditt senaste köp?', 'nutrisslim-suite'); ?></p>
                <p><?php echo esc_html__('Som tack för din tid skickar vi en speciell gåva tillsammans med din beställning!', 'nutrisslim-suite'); ?></p>

                <h4><?php echo esc_html__('Din beställning', 'woocommerce'); ?></h4>
                ...
                <h4><?php echo esc_html__('Betygsätt och recensera ditt köp', 'nutrisslim-suite'); ?></h4>
            </div>
            ...
            <div class="form">
                <div class="nf-review_form">
                    <div class="review_fields">
                        ...
                        <textarea name="review_review" id="review_text" cols="30" rows="5" placeholder="<?php echo esc_attr__('Berätta vad du tycker','nutrisslim-suite'); ?>"></textarea>
                        <button id="send_reviews"><?php echo esc_html__('Skicka','woocommerce'); ?></button>
                    </div>
                </div>
            </div>
        </div>
